...
import { CABINET_DATA, NEIGHBORNET_DATA, ALL_SHURA_DATA, COLORS, DEFAULT_CALENDAR_ID } from './constants';
...
const App: React.FC = () => {
  ...
  // Extract NNC Leadership for visuals
  ...
  // Static Calendar URL using the specific ID and timezone requested by the user
  const calendarUrl = `https://calendar.google.com/calendar/embed?src=${encodeURIComponent(DEFAULT_CALENDAR_ID)}&ctz=America%2FChicago&wkst=1&bgcolor=%23ffffff&showTitle=0&showNav=1&showDate=1&showPrint=0&showTabs=1&showCalendars=0&showTz=1`;
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] flex flex-col font-['Poppins']">
      ...
      <div className="bg-white border-b border-gray-100 sticky top-0 z-40 shadow-sm">
        <div className="max-w-7xl mx-auto px-8 flex gap-8 text-center md:text-left overflow-x-auto no-scrollbar">
          <a href="#calendar" className="py-5 text-[10px] md:text-sm font-black uppercase tracking-widest text-[#0b3d2e] border-b-2 border-[#0b3d2e] whitespace-nowrap">Sub-Regional Calendar</a>
          <a href="#visuals" className="py-5 text-[10px] md:text-sm font-black uppercase tracking-widest text-gray-400 hover:text-[#0b3d2e] transition-colors whitespace-nowrap">Shura Visuals</a>
          <a href="#directory" className="py-5 text-[10px] md:text-sm font-black uppercase tracking-widest text-gray-400 hover:text-[#0b3d2e] transition-colors whitespace-nowrap">Directory</a>
        </div>
      </div>

      <main className="flex-1 max-w-7xl mx-auto w-full px-4 md:px-8 py-12 md:py-20">
        <div className="space-y-16 md:space-y-24">
          
          {/* Sub-Regional Calendar Section */}
          <section id="calendar" className="bg-white p-6 md:p-12 rounded-[3.5rem] shadow-xl border border-gray-50 scroll-mt-24">
            <div className="flex items-center justify-between mb-8 md:mb-12">
              <div>
                <h2 className="text-4xl font-black text-gray-900 tracking-tight">Sub-Regional Calendar</h2>
                <p className="text-xs text-gray-400 font-bold uppercase tracking-widest mt-1">Official MA/RI Schedule</p>
              </div>
            </div>
            ...
            <div className="relative w-full aspect-video md:aspect-[21/9] rounded-[2rem] overflow-hidden border border-gray-100 bg-gray-50 shadow-inner">
              <iframe 
                ...
                frameBorder="0" 
                scrolling="no"
                title="Official Sub-Regional Calendar"
              ></iframe>
            </div>
          </section>
      ...
      <footer className="w-full bg-white border-t border-gray-100 py-16">
        <div className="max-w-7xl mx-auto px-8 flex flex-col items-center gap-6">
          ...
          <div className="flex gap-8 text-[10px] font-black text-gray-400 tracking-widest uppercase text-center">
